// import { Avatar, Text, Grid, Card, Center, Loader, Group, GridCol } from "@mantine/core";
...
// import { Edit } from "tabler-icons-react"; // يمكنك استخدام أي Icon آخر مثل <EditIcon />
...
//   // عند فتح النافذة، نضع البيانات الحالية
//   useEffect(() => {
//     if (profile) {
//       setFormData({
...
//   const image = profile.user.picture || "";
...
//               <GridCol span={8} className={classes.AvatarProfile}>
// <h3 style={{
//   textAlign: "start",
//   padding: "0px 10px"
...
//       {/* Edit Modal */}
//       <Modal opened={opened} onClose={close} title={t.editProfile} centered>
//         <TextInput
//           label={t.name}
//           name="name"
//           value={formData.name}
...
//   const mutationEditProfile = useEditProfileMarketer(user.token, closeFormModal);
