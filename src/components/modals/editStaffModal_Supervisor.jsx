...
// components/UpdateStaffModal.jsx
import React, { useEffect, useState } from "react";
import { Modal, TextInput, Button, Group, Text, Loader, FileInput } from "@mantine/core";
...
const UpdateStaffModal = ({ opened, onClose, employee, onUpdateSuccess }) => {
  ...
  useEffect(() => {
    if (employee) {
      setFormData({ name: employee.name || "", phone_number: employee.phone_number || "", image: null });
      setErrors({});
      setValid({});
      setHasChanges(false);
    }
  ...
  return (
    <Modal opened={opened} onClose={onClose} title="Update Staff" centered size="lg">
      <TextInput
        label="Name"
        name="name"
        value={formData.name}
      ...
      <Group justify="flex-end" mt="xl">
        <Button onClick={handleUpdateEmployee} loading={loading} disabled={!hasChanges}>
          Update
        </Button>
      </Group>
    </Modal>
