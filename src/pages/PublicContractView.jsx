...
export default function PublicContractView() {
  ...
  useEffect(() => {
    const fetchContract = async () => {
      ...
      try {
        ...
        const finalLink = `https://real-estate-one-lake.vercel.app/#/ShareContracts/${decodedPath}`;
  ...
  const handleDeleteContract = () => {
    // يمكنك ربط هذا بالـ API لحذف العقد
...
//           }
//           <GridCol span={6}>
//             <Text><strong>Customer Nasfasame:</strong> {contract.customer_name}</Text>
