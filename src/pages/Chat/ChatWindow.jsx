    ...
    <>
                          ...
                          msg.is_mine ? (
                            ...
                            >
                              <path
                                ...
                                fill={
                                  !msg.is_mine ? "var(--color-1)" : "#e6e6e6"
                                }
                              />
                            </svg>
                          ) : null
      ...
      <Modal
        ...
        styles={{
          ...
          close: { color: "var(--color-1)" },
        }}
      >
        {console.log(data?.conversation_with)}
        ...
        <Text
          ...
          onClick={() => {
            ...
            if (
              ...
              (data?.conversation_with?.role === "supervisor")
            ) {
              path = `/dashboard-supervisor/Team/${data?.conversation_with?.id}`;
            } else if (user?.role === "company") {
              if (data?.conversation_with?.role === "employee") {
                path = `/dashboard/employee/${data?.conversation_with?.id}`;
              } else if (data?.conversation_with?.role === "supervisor") {
                path = `/dashboard/supervisor/${data?.conversation_with?.id}`;
              }
            }
        ...
        >
          ...
          onClick={() =>
            navigate(
              (user?.role === "company") &
                (data?.conversation_with?.role === "employee")
                ? `/dashboard/employee/${data?.conversation_with.id}`
                : `/dashboard/supervisor/${data?.conversation_with.id}`
          ...
          color="dimmed"
        > */}
          <strong>NameDS : </strong> {data?.conversation_with?.name}
        </Text>
        <Text
          style={{
            cursor: "pointer",
          ...
          color="dimmed"
        >
          <strong>role : </strong> {data?.conversation_with?.role}
        </Text>
      </Modal>
    </>
  );
