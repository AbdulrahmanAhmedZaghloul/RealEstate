...
function Profile() {
  ...
  function validateSaudiPhoneNumber(phoneNumber) {
    const saudiPhoneNumberRegex = /^(009665|9665|\+9665|05|5)(5|0|3|6|4|9|1|8|7)([0-9]{7})$/;
  ...
  const handleUpdateProfile = async () => {
    ...
    if (!validateSaudiPhoneNumber(formPhone)) {
      ...
      return; // نتوقف هنا إذا كان الرقم غير صحيح
    }
      ...
      <Card className={classes.mainContainer} radius="lg">
        ...
        <Card radius="lg" mt="16px" className={classes.profileContainer}>
          ...
          <Modal opened={formModalOpened} onClose={closeFormModal} centered radius="lg" className={classes.Modal}>
            ...
            <TextInput
              ...
              onChange={(e) => {
                ...
                if (digitsOnly.startsWith("966")) {
                  ...
                  setFormPhone(numberWithoutCode);
                } else {
            ...
            />
            {/* Contact Number with Auto Formatting & Saudi Flag */}
            {/* <TextInput
              label="Contact Number"
              mt="md"
              w="100%"
...
//     setFormBio(currUser.company.bio);
//     setFormImage(currUser.company.picture_url);
//     console.log(currUser.company.bio);
